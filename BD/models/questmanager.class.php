...
protected $FileList;
	...
	public function __construct( $inDataArray =array() )
	{
		...
		if( isset($inDataArray['revisors']) ) 			{ $this->Revisers = $inDataArray['revisors']; }
		...
		if( isset($inDataArray['filelist']) ) 			{ $this->FileList = $inDataArray['filelist']; }
	}
	...
	public function GetRevisors() { return $this->Revisors; }
	...
	public function SetRevisors($inList) { $this->Revisors = $inList; }
	public function SetScriptors($inList) { $this->Scriptors = $inList; }

	public function SetTitles($inList) { $this->Titles = $inList; }
	public function SetTitlePowers($inList) { $this->TitlePowers = $inList; }

	public function SetFileList($inList) { $this->FileList = $inList; }
	...
	public function GetFileCount() { return count($this->FileList); }
