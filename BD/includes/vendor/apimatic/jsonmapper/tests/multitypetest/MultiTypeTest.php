...
class MultiTypeTest extends TestCase
{
    ...
    {
        $mapper = new MultiTypeJsonMapper();
        $value = new \DateTime("now", new DateTimeZone("America/Montreal"));
        $this->assertEquals('DateTime', $mapper->getType($value));
        $value = new Car("3", true);
        $this->assertEquals('Car', $mapper->getType($value));
        $value = [new \DateTime("now", new DateTimeZone("America/Montreal")), new \DateTime("now", new DateTimeZone("America/Montreal"))];
        $this->assertEquals('DateTime[]', $mapper->getType($value));
        $value = [new Car("3", true), new \DateTime("now", new DateTimeZone("America/Montreal"))];
